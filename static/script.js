...
let canvas_prop = canvas.getContext("2d"); // 2D rendering context provides methods and properties for drawing on the canvas.
...
//Function to draw complex unit circle and its axes

function setCanvas(){
canvas_prop.beginPath();
canvas_prop.arc(180,180,160,0,2*Math.PI,false);
canvas_prop.lineWidth = 2;
canvas_prop.strokeStyle = "black";
canvas_prop.stroke();

canvas_prop.beginPath();
canvas_prop.moveTo(0,180);
canvas_prop.lineTo(360,180);
canvas_prop.lineWidth = 1.0;
canvas_prop.stroke();

canvas_prop.beginPath();
canvas_prop.moveTo(180,0);
canvas_prop.lineTo(180,360);
canvas_prop.lineWidth = 1.0;
canvas_prop.stroke();
